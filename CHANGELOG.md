...
- Added contributor and roadmap documentation.
- Added footer credit in macOS/Python and Windows UI.
- Added basic tests for text preparation and chunking.
- Added GitHub Actions workflows for CI and downloadable build artifacts.
